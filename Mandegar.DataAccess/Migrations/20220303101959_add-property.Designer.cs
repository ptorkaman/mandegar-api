...
namespace Mandegar.DataAccess.Migrations
{
    ...
    [Migration("20220303101959_add-property")]
            ...
            modelBuilder.Entity("Mandegar.Models.Entities.Departments.SessionApprovalMembers", b =>
                {
                    ...
                    b.Property<int>("SessionApprovalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mandegar.Models.Entities.User.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(7493),
                            Index = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "کاربر عادی",
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(8966),
                            Index = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "مدیر ارشد",
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(8986),
                            Index = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "مدیر",
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(8992),
                            Index = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "پنل مدیریت",
                        ...
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(8997),
                            Index = 1,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "مدیریت کاربران",
                        ...
                        {
                            Id = 5,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9538),
                            Index = 1,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "افزودن کاربر",
                        ...
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9556),
                            Index = 1,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "ویرایش کاربر",
                        ...
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9561),
                            Index = 1,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "حذف کاربر",
                        ...
                        {
                            Id = 27,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9565),
                            Index = 2,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "مدیریت نقش‌ها",
                        ...
                        {
                            Id = 28,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9569),
                            Index = 2,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "افزودن نقش",
                        ...
                        {
                            Id = 29,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9574),
                            Index = 2,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "ویرایش نقش",
                        ...
                        {
                            Id = 30,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 557, DateTimeKind.Local).AddTicks(9578),
                            Index = 2,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "حذف نقش",
            ...
            modelBuilder.Entity("Mandegar.Models.Entities.User.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 555, DateTimeKind.Local).AddTicks(4676),
                            Email = "-",
                            Family = "سیستم",
                            Gender = true,
                            IsActive = true,
            ...
            modelBuilder.Entity("Mandegar.Models.Entities.User.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 556, DateTimeKind.Local).AddTicks(6707),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "کاربران عادی",
                            ShowInList = false
                        ...
                        new
                        {
                            Id = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 556, DateTimeKind.Local).AddTicks(8414),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "مدیر ارشد",
                            ShowInList = false
            ...
            modelBuilder.Entity("Mandegar.Models.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2022, 3, 3, 13, 49, 55, 547, DateTimeKind.Local).AddTicks(5439),
                            IsActive = true,
                            IsDeleted = false,
                            Password = "aUMRrPiiPVPyDld0loRhog==",
                            RequestCode = "v4Uq24MXK-1/=/2-2Vjm0HdAVLVKHSwtcMGMA6oX5LnF-1/=/2-T8YdNCl3xqoZJErtSYcegMjSZ",
                            Username = "mandegar"
                        });
                });
